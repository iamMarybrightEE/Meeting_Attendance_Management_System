...
import { ACCOUNT_STATUS, DEPARTMENTS, ROLES_DATA } from "../../../data/dummyData";
          ...
          <Box sx={{ display: "flex", gap: 1.5, flexWrap: "wrap" }}>
            <FormControl size="small" sx={{ minWidth: 130 }}>
              ...
              <Select
                ...
                label="Role"
                sx={{ borderRadius: 2, fontSize: "0.82rem", bgcolor: "#f9fafb" }}
              >
                <MenuItem value="All">All Roles</MenuItem>
                {ROLES_DATA.map((r) => <MenuItem key={r.id} value={r.name}>{r.name}</MenuItem>)}
              </Select>
            </FormControl>
                      ...
                      >
                        <TableCell sx={{ py: 1.5 }}>
                          <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                            <Avatar
                              sx={{ width: 34, height: 34, bgcolor: avatarColor, fontSize: "0.72rem", fontWeight: 700 }}
                            >
                            ...
                            <Box>
                              <Typography
                                ...
                                sx={{
                                  ...
                                  fontSize: "0.82rem",
                                  cursor: "pointer",
                                  "&:hover": { color: "#004497", textDecoration: "underline" },
                                }}
                        ...
                        <TableCell>
                          <Typography variant="caption" sx={{ fontFamily: "monospace", color: "#555", bgcolor: "#f3f4f6", px: 1, py: 0.3, borderRadius: 1 }}>
                            {user.employeeId}
                          </Typography>
                        </TableCell>
                        <TableCell>
                          ...
                          <Box sx={{ display: "flex", gap: 0.5 }}>
                            <Tooltip title="View Profile">
                              <IconButton
                                size="small"
                                onClick={() => router.push(`/user-profile/${user.id}`)}
                                sx={{ color: "#6b7280", "&:hover": { color: "#004497", bgcolor: "#f0f4ff" } }}
                              >
                            ...
                            <Tooltip title="Edit User">
                              <IconButton
                                ...
                                sx={{ color: "#6b7280", "&:hover": { color: "#1c56a3", bgcolor: "#e0eaff" } }}
                              >
                                <Edit sx={{ fontSize: 16 }} />
                              </IconButton>
                            </Tooltip>
                            <Tooltip title="Reset Password">
                              <IconButton
                                ...
                                sx={{ color: "#6b7280", "&:hover": { color: "#FFB236", bgcolor: "#fff3cd" } }}
                              >
          ...
          <Box sx={{ p: 2, display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid #e8edf3" }}>
            ...
            <Pagination
              ...
              sx={{
                ...
                "& .Mui-selected": { bgcolor: "#004497", color: "#fff" },
              }}
            />
          </Box>
        )}
